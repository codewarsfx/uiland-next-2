...
export default function SinglePage({ screens }) {
  ...
  return (
    <>
      ...
      <SingleHeader>
        <BrandLogo imageUrl={headerInfo.logo} />
        <Title>{headerInfo.Name}</Title>
        <WebLink href={headerInfo.websiteLink}>
          {headerInfo.websiteLink}
        </WebLink>
        {getAlbumId.includes(router.query.id) ? (
          <button className="" onClick={handleDeleteFromBookMark}>
            <img
          ...
          <button className="" onClick={handleAddToBookMark}>
            <img
        ...
        <div className="album-card__divc">
          ...
          <span>
            ...
            <a
              href={`https://wa.me/?text=http://localhost:3000/single/${router.query.id}`}
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href={`https://telegram.me/share/url?url=http://localhost:3000/single/${router.query.id}`}
              target="_blank"
              rel="noreferrer"
            >
